...
* **Action:** Consider remapping GPIB signals to non-JTAG pins (e.g., GPIOs 16, 17, 18, 19, 21, 22, 23, 25, 26, 27) to allow for simultaneous debugging.
* **Action** implement a convenient JTAG connector
